...
class VideoFactory
{
   ...
   */
    public static function make($video, $user_id): ?array
    {
      $paragraphs = [];
   ...
   * @throws \Drupal\Core\Entity\EntityStorageException
   */
    public static function createEmbedFromSrc($string, $user_id): Paragraph
    {
      $e = null;
      if($string)
      {
   ...
   * @throws \Drupal\Core\Entity\EntityStorageException
   */
    public static function createMp4($path, $file_name = null, $user_id): Paragraph
    {
