...
class Helper
{
   ...
   * @return bool
   */
  public static function validCsv($headers_data): bool
  {
    $is_valid = FALSE;
   ...
   * @return bool
   */
  public static function checkEasyMatch(array $article_data, array $language_keys): bool
  {
    // data columns
   ...
   * @return null
   */
  public static function parseShortCode($string, $tag): ?string
  {
    $regex = '#{'.$tag.'}(.*?){/'.$tag.'}#';
   ...
   * @return string
   */
  public static function parseEmbed($string): ?string
  {
   ...
   * @return bool
   */
  public static function is_absolute($url): bool
  {
...
(?:[\w#!:\.\?\+=&@$'~*,;\/\(\)\[\]\-]|%[0-9a-f]{2})*)?$/xi";
   ...
   * @return mixed
   */
  public static function entityToString($v): string
  {
    return is_string($v) ?
   ...
   * @return array
   */
  public static function articleAlias($string, $node_id, $lang_code): ?array
  {
    $values = [];
   ...
   * @return array
   */
  public static function channelAlias($string, $tax_id, $lang_code): ?array
  {
    $values = [];
   ...
   * @return bool
   */
  public static function checkPromotionArticle(array $article_data, array $language_keys): bool
  {
   ...
   * @return bool
   */
  public static function checkDraftArticle(array $article_data, array $language_keys): bool
  {
    return Helper::checkEasyMatch($article_data, $language_keys);
  }
   ...
   * @return string
   */
  public static function getDivContent($data, $className): string
  {
   ...
   * @return array|null
   */
  public static function imagesFromString($data): ?array
  {
    $i = null;
    $doc = new \DOMDocument();
   ...
   * @return null
   */
  public static function getVideoJSPath($string): ?string
  {
    $page = new \DOMDocument();
   ...
   * @return array
   */
  public static function findGalleryImagesInString($string): ?array
  {
